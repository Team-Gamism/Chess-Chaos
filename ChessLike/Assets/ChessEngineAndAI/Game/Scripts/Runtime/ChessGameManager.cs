    ...
    public class ChessGameManager : MonoBehaviour
    {
        ...
        public Selection Selected
        {
            ...
            set
            {
                ...
                if (m_Selected.visualTile != null)
                {
                    ...
                    // Invoke the internal 'Unhighlighted' callback.
                    m_Selected.visualTile.Internal_OnUnhighlighted();
                }
                ...
                {
                    if (m_SelectedHighlightMaterial != null)
        ...
        protected virtual void OnSelectionChanged()
        {
            ...
            foreach (VisualChessTableTile tile in m_HighlightedTiles)
            {
                ...
                // Invoke the internal 'Unhighlighted' callback for the visualTile.
                tile.Internal_OnUnhighlighted();
            }
            ...
            if (m_Selected.visualPiece != null)
            {
                ...
                foreach (ChessTableTile tile in m_Selected.validMoves)
                {
                    ...
                    if (m_MoveHighlightMaterial != null)
                        visualTile.Renderer.material = m_MoveHighlightMaterial;
                    m_HighlightedTiles.Add(visualTile);

                    // Invoke the internal 'Move Highlighted' callback for the visualTile.
                    visualTile.Internal_OnMoveHighlighted();
                }
                ...
                foreach (AttackInfo attackInfo in m_Selected.validAttacks)
                {
                    ...
                    if (m_AttackHighlightMaterial != null)
                        visualTile.Renderer.material = m_AttackHighlightMaterial;
                    m_HighlightedTiles.Add(visualTile);

                    // Invoke the internal 'Attack Highlighted' callback for the visualTile.
                    visualTile.Internal_OnAttackHighlighted();
                }
            }
