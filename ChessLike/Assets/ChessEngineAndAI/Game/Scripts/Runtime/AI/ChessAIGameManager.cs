...
namespace ChessEngine.Game.AI
{
    ...
    public class ChessAIGameManager : ChessGameManager
    {
        ...
        public void InitializeBlackAI()
        {
            ...
            if (BlackAIInstance != null)
                InitializeAIInstance(BlackAIInstance);
        }
        ...
        public void InitializeWhiteAI()
        {
            ...
            if (WhiteAIInstance != null)
                InitializeAIInstance(WhiteAIInstance);
        }
        #endregion
        ...
        void InitializeAIInstance(ChessAI pChessAI)
        {
        ...
        /// <summary>Deinitializes the chess AI instance, pChessAI.</summary>
        /// <param name="pChessAI"></param>
        void DeinitializeAIInstance(ChessAI pChessAI)
        {
            // Unsubscribe from the relevant event(s).
            pChessAI.BestMoveSubmitted -= OnBestMoveSubmitted;

            // Deinitialize the AI.
            pChessAI.OnDeinitialized();
        }
        ...
        {
            if (BlackAIInstance != null)
                DeinitializeAIInstance(BlackAIInstance);
        ...
        {
            if (WhiteAIInstance != null)
                DeinitializeAIInstance(WhiteAIInstance);
